...
1. **Classify** whether the problem is domain logic, infrastructure, or presentation.
2. **Propose** the cleanest architectural approach.
3. **Then** provide implementation.
4. **Mention** potential edge cases.
5. **Mention** performance considerations.
6. **Mention** tests to add or update, and how to run them.
